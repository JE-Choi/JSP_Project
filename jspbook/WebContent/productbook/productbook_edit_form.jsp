<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" errorPage="productbook_error.jsp" import="jspbook.productbook.*"%>
<!DOCTYPE HTML>
<html>
<head>
...
<script type="text/javascript">
	function delcheck(){
		...
		//pd_id = pb.getProduct_id();
		
		//document.location.href = "productbook_control.jsp?action=delete&pb_id="+pb_id+"&pwd="+pwd;
	}
</script>
</head>

<jsp:useBean id="pb" scope="request" class="jspbook.productbook.ProductBook" />
